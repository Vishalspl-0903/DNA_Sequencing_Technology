...
for d in "$HOME"/scratch/*/flye; do
  ...
  if [ ! -s "/mnt/d/Plasmid-GNN/DNA_Sequencing_Technology/work/asm/$tag/assembly_graph.gfa" ]; then
...
bash /mnt/d/Plasmid-GNN/DNA_Sequencing_Technology/work/scripts/08_batch_flye.sh
